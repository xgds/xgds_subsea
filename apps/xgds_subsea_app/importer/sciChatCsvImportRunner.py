...
def main():
    ...
    importer = sciChatCsvImporter.SciChatCsvImporter(opts.config, opts.input, force=opts.reload, replace=opts.replace, skip_bad=opts.skip_bad)
