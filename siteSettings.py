...
XGDS_MAP_SERVER_JS_MAP[XGDS_SAMPLE_SAMPLE_KEY] = {'ol': 'xgds_sample/js/olSampleMap.js',
                                                  ...
                                                  'columns': ['checkbox', 'collection_time', 'name', 'sample_type_name', 'place_name', 'label_number', 'collector_name', 'vehicle_name', 'thumbnail_image_url',  'pk', 'lat', 'lon', 'alt', 'depth', 'flight_name', 'app_label', 'model_type', 'type', 'description', 'collection_timezone', 'DT_RowId'],
                                                  'hiddenColumns': ['thumbnail_image_url', 'collection_timezone', 'pk', 'lat', 'lon', 'alt', 'depth', 'label_number', 'collector_name', 'flight_name', 'vehicle_name', 'app_label', 'model_type', 'type', 'description',  'DT_RowId'],
